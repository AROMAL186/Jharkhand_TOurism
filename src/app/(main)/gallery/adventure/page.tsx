...
import { adventureDestinations } from '@/lib/data';
    ...
    <div className="container mx-auto">
      ...
      <Card className="border-none shadow-none mb-8">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-headline font-bold">Adventure in Jharkhand</CardTitle>
          <CardDescription className="text-lg">
            Discover thrilling destinations for trekking, rock climbing, and more.
          </CardDescription>
        </CardHeader>
      </Card>
